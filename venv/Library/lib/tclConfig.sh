...
# installed.
TCL_PREFIX='E:/Machine learning/Projects/Git/Credit_Card_Fraud_detection/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/Machine learning/Projects/Git/Credit_Card_Fraud_detection/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/Machine learning/Projects/Git/Credit_Card_Fraud_detection/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/Machine learning/Projects/Git/Credit_Card_Fraud_detection/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/Machine learning/Projects/Git/Credit_Card_Fraud_detection/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/Machine learning/Projects/Git/Credit_Card_Fraud_detection/venv\Library\lib\tclstub86.lib'
